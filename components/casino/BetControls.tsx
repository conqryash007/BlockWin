    ...
    <div className="flex h-full flex-col gap-6 bg-black/20 backdrop-blur-md p-4 md:w-[320px] md:border-r border-white/5 relative z-10">
      <Tabs defaultValue="manual" className="w-full">
        ...
        <TabsContent value="manual" className="space-y-6 mt-6">
            ...
            <div className="space-y-3">
                 <Label className="text-gray-400 text-xs font-bold uppercase tracking-wider">Profit on Win</Label>
                 <Input readOnly value={(betAmount * 1.98).toFixed(2)} className="font-mono bg-black/40 border-casino-brand/20 text-casino-brand font-bold h-12" />
            </div>

            <Button className="w-full h-16 text-xl font-black uppercase tracking-widest bg-casino-brand text-black hover:bg-casino-brand/90 shadow-[0_0_20px_rgba(0,255,163,0.3)] transition-all hover:scale-[1.02] active:scale-[0.98] border-0 mt-4 rounded-xl">
                Bet Now
            </Button>
        </TabsContent>
