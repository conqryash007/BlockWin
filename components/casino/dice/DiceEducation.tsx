  ...
  return (
    <div className="relative py-16 px-4 max-w-[1440px] mx-auto">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-20">
        <Dice1
          className="absolute top-10 left-10 w-24 h-24 text-casino-brand/30 animate-spin-slow"
          style={{ animationDuration: "20s" }}
        />
        <Dice6
          className="absolute bottom-20 right-20 w-32 h-32 text-casino-brand/20 animate-spin-slow"
      ...
      <div className="text-center mb-16 relative z-10">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-casino-brand/10 border border-casino-brand/30 shadow-[0_0_20px_rgba(0,255,163,0.2)] mb-6">
          ...
          <span className="text-base font-bold text-casino-brand uppercase tracking-wide">
            Learn & Win
          </span>
        </div>
        ...
        <p className="text-base text-gray-300 max-w-2xl mx-auto">
          Simple rules, big rewards. Everything you need to know about the Dice
          game.
        </p>
      </div>
      ...
      <div className="space-y-12 relative z-10">
        ...
        <div className="bg-gradient-to-br from-[#1a1c24] to-[#0f1115] rounded-2xl border-2 border-casino-brand/20 shadow-[0_0_15px_rgba(0,255,163,0.15)] p-8">
          ...
          <div className="space-y-6 pt-6 text-gray-200 leading-relaxed">
            <p className="text-lg">
              The Dice game is a simple yet exciting game of chance where you
              predict whether a randomly generated number will fall within your
              chosen range.
            </p>
              ...
              <ul className="space-y-3 list-none">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    Select how much you want to wager on each roll.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-casino-brand shrink-0 mt-0.5" />
                  <span>
                    <strong className="text-white">Set Your Target:</strong> Use
                    the slider to choose a target number between 1 and 98.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-casino-brand shrink-0 mt-0.5" />
                  <span>
                    ...
                    Decide if you want the result to be over or under your
                    target number.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-casino-brand shrink-0 mt-0.5" />
                  <span>
                    <strong className="text-white">Place Your Bet:</strong>{" "}
                    Click the "Bet" button to roll the dice.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-casino-brand shrink-0 mt-0.5" />
                  <span>
                    <strong className="text-white">Win or Lose:</strong> If the
                    rolled number falls in your predicted range, you win!
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-casino-brand/5 p-5 rounded-lg border-2 border-casino-brand/30">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  • <strong>Higher Win Chance = Lower Multiplier:</strong>{" "}
                  Setting a target closer to 50 gives you better odds but
                  smaller payouts.
                </li>
                <li>
                  • <strong>Lower Win Chance = Higher Multiplier:</strong>{" "}
                  Setting extreme targets (close to 0 or 100) offers huge
                  payouts but lower odds.
                </li>
                <li>
                  • <strong>Balance Risk and Reward:</strong> Find your sweet
                  spot between safety and potential profit.
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-br from-[#1a1c24] to-[#0f1115] rounded-2xl border-2 border-yellow-500/20 shadow-[0_0_15px_rgba(234,179,8,0.15)] p-8">
          ...
          <div className="space-y-6 pt-6 text-gray-200 leading-relaxed">
            <p className="text-lg">
              Your payout is determined by your win chance percentage. The
              formula is simple:{" "}
              <strong className="text-white">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-bold text-white">
                          {item.chance} Win Chance
                        </p>
                        <p className="text-xs text-gray-400">{item.risk}</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <p className="text-xl font-black text-casino-brand">
                        {item.multi}
                      </p>
            ...
            <div className="bg-yellow-500/5 p-5 rounded-lg border-2 border-yellow-500/30">
              ...
              <p className="text-sm text-gray-300">
                Always bet responsibly and never wager more
        ...
        <div className="bg-gradient-to-br from-[#1a1c24] to-[#0f1115] rounded-2xl border-2 border-purple-500/20 shadow-[0_0_15px_rgba(168,85,247,0.15)] p-8">
          ...
          <div className="space-y-6 pt-6 text-gray-200 leading-relaxed">
            <p className="text-lg">
              Every roll in our Dice game is{" "}
              <strong className="text-white">100% provably fair</strong>. This
              means you can independently verify that each result was truly
              random and not manipulated in any way.
            </p>
              ...
              <ul className="space-y-4 list-none">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300 mt-1">
                      The casino generates a random server seed before each game
                      session. This seed is hashed and shown to you, so we can't
                      change it later.
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300 mt-1">
                      You can provide your own client seed (or use a randomly
                      generated one). This ensures you have control over the
                      randomness.
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300 mt-1">
                      A counter that increases with each bet, ensuring every
                      roll is unique even with the same seeds.
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300 mt-1">
                      After each roll, you can verify the result by combining
                      the server seed, client seed, and nonce. The hash will
                      match the pre-disclosed hash, proving fairness.
                    </p>
                  </div>
                </li>
              </ul>
            ...
            <div className="bg-casino-brand/5 p-5 rounded-lg border-2 border-casino-brand/30">
              <p className="text-base font-semibold text-casino-brand mb-3">
                Why This Matters:
              </p>
              <ul className="space-y-2 text-sm text-gray-300">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Cannot Be Rigged:</strong>{" "}
                    The server seed is locked before you bet, so outcomes can't
                    be manipulated.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-casino-brand">✓</span>
                  <span>
                    <strong className="text-white">Fully Transparent:</strong>{" "}
                    All game results can be independently verified by anyone.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-casino-brand">✓</span>
                  <span>
                    ...
                    Uses industry-standard hashing algorithms for maximum
                    security.
                  </span>
                </li>
              </ul>
            ...
            <p className="text-sm text-gray-400 italic text-center pt-2">
              Click the "Provably Fair" button in the game controls to view your
              current seeds and verify your bets.
            </p>
          </div>
        </div>
      </div>
