...
export const SUPPORTED_TOKENS = {
  ...
  USDC: {
    symbol: 'USDC',
    name: 'USD Coin',
    address: '0x83dB56E78912C649495B9a63E85b000fc73CD0f3' as const, // Sepolia USDC
    decimals: 6,
    supportsPermit: true, // USDC supports EIP-2612
  },
  DAI: {
    symbol: 'DAI',
    name: 'Dai Stablecoin',
    address: '0xaCAaBf070D3B9E5EBf416b9b950ED4B3E19c81Db' as const, // Sepolia DAI
    decimals: 6,
    supportsPermit: true, // DAI supports EIP-2612
  },
} as const;
...
export const CONTRACTS = {
  ...
  CasinoDeposit: {
    address: '0x2432E0a2c34C764449525269be6554Dce899340c' as const,
    abi: [
    {
      "inputs": [],
  ...
  // ERC20Permit ABI for EIP-2612 tokens (USDC, DAI)
  ERC20Permit: {
    abi: [
      {
        inputs: [
