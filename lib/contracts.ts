...
// Environment-based network selection for testnet/mainnet
// ============================================
...
const TESTNET_TOKENS = {
  USDT: {
    symbol: "USDT",
    name: "Tether USD",
    address: "0x27D4F6456D51f6A1f943C1f599c36D2E4F5958aF" as const,
    decimals: 6,
    supportsPermit: false, // USDT doesn't support EIP-2612
  },
  USDC: {
    symbol: "USDC",
    name: "USD Coin",
    address: "0x83dB56E78912C649495B9a63E85b000fc73CD0f3" as const,
    decimals: 6,
    supportsPermit: true,
  },
  DAI: {
    symbol: "DAI",
    name: "Dai Stablecoin",
    address: "0xaCAaBf070D3B9E5EBf416b9b950ED4B3E19c81Db" as const,
    decimals: 6,
    supportsPermit: true,
  },
} as const;
...
const MAINNET_TOKENS = {
  ...
  DAI: {
    ...
    decimals: 18, // DAI on mainnet uses 18 decimals
    supportsPermit: true,
  },
} as const;
...
// ============================================
// CasinoDeposit Contract ABI
// ============================================

const CASINO_DEPOSIT_ABI = [
  {
    inputs: [],
...
// ============================================
// CONTRACTS Export (Dynamic based on environment)
// ============================================
...
export const CONTRACTS = {
  ...
  CasinoDeposit: {
    address: activeNetworkConfig.casinoDepositAddress,
    abi: CASINO_DEPOSIT_ABI,
  },
